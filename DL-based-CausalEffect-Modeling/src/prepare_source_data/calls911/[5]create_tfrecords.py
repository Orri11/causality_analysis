import sys
import os
os.chdir('/Users/orshahar/Desktop/School/causality_analysis/DL-based-CausalEffect-Modeling')
sys.path.insert(0, ".")


import src.models.DeepProbCP.tfrecords_handler.moving_window.tfrecord_writer as tw
import os
