...
if __name__ == '__main__':
    tfrecord_writer = tw.TFRecordWriter(
        ...
        validate_file_path = 'data/elec_price/moving_window/priceMT_' + \
            str(input_size) + '_' + str(output_size) + '_val' + '.txt',
        test_file_path = 'data/elec_price/moving_window/priceMT_' + \
            str(input_size) + '_' + str(output_size) + '_test' + '.txt',
        
        binary_train_file_path = output_path + 'priceMT_' + \
            str(input_size) + '_' + str(output_size) + '_train' + '.tfrecords',
        binary_validation_file_path = output_path + 'priceMT_' + \
            str(input_size) + '_' + str(output_size) + '_val' + '.tfrecords',
        binary_test_file_path = output_path + 'priceMT_' + \
